...
import com.alunoonline.Aluno.Online.model.dtos.DisciplinasAlunoDto;
...
public class MatriculaAlunoService {
    ...
    static final Double GRADEAVGTOAPPROVE = 7.00;
    ...
    public void atualizaStatusToBreak(Long matriculaAlunoId) {
        Optional<MatriculaAluno> matriculaAlunoToUpdate = repository.findById(matriculaAlunoId);
